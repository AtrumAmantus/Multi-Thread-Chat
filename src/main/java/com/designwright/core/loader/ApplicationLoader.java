...
import com.designwright.core.container.ApplicationBean;
import com.designwright.core.container.ApplicationContext;
...
import com.designwright.core.server.Server;
import com.designwright.core.server.ServerRunner;
...
public class ApplicationLoader extends AbstractLoader {
    ...
    void startServers() {
        List<Server> servers = this.context.getBeansOfType(Server.class);

        if (!servers.isEmpty()) {
            new ServerRunner(servers).init();
        }
    }
